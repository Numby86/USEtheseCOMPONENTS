        ...
        <div className='detail'>
            ...
            <div className='html'>
                <div className='logoHtml' >
                    <h3><img className='logosHTMLCSS' src='https://w7.pngwing.com/pngs/201/90/png-transparent-logo-html-html5.png' alt='logo'/></h3>
            ...
            <div className='scss'>
                <div className='logoScss' >
                    <h3><img className='logosHTMLCSS' src='https://w7.pngwing.com/pngs/696/424/png-transparent-logo-css-css3-thumbnail.png' alt='logo'/></h3>
